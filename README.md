...
You can install the package via UPM by adding the lines below to your project's manifest.json file. You can find this file by opening your project's *Packages* folder in a file browser, it is not displayed in the editor.
